...
set linker_flags=/LIBPATH:..\external\glfw\lib /LIBPATH:..\external\lua-5.3.2\lib glfw3.lib lua51.lib opengl32.lib gdi32.lib user32.lib shell32.lib /NODEFAULTLIB:LIBCMTD
